...
function send_post_request(url1,data)
{
    ...
    $.ajax({
        ...
        success:(data)=>{
            ...
            students.forEach(student => {
                ...
                <td class="d-flex">
                <button class="btn btn-info m-1 p-1"  type="button"  data-bs-toggle="modal" data-bs-target="#student${ fields.phone_number }">
                ...
                <button class="btn btn-danger px-1 my-1 mx-2"> <a href="../student/edit/${adm}" class="nav-link text-light"><i class="fa fa-eye"></i>edit</a>  </button>
        
                 <button class="btn btn-danger mx-2 my-1 py-0 px-1" data-bs-target="#delstudent${fields.phone_number}" data-bs-toggle="modal"> <i class="fa fa-trash"></i>del</button>
